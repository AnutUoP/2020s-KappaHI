...
print((covariance[1][1]**0.5)*2)
mean = [0.7, 0.3,  0.8, 0.97, 0.67, 0.18, 0.05] 
'''
...
g.triangle_plot([gauss1],filled=True,legend_labels=['16-HIHI'])
...
plt.savefig('bias2_HIHI_7params.png')
plt.close()
...
x = np.arange(16)+1
y1 = FoM/(10**5)
plt.plot(x,y1,'bo',label=r'$\sigma_8-\Omega_m$ HIHI only')
...
plt.legend()
#plt.show()
plt.savefig('FoM_HIHI_7params.png')