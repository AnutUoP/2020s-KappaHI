...
for i in range(6):
    u[i] = hp.read_cl('u_grad/wmap_'+str(i)+'_KHI_zi'+sys.argv[1]+'_zs13.fits') 
C_HIHI = np.zeros((15,15))

#Ck9 = np.zeros((15,15))
#KHI_covzHI1_kzs13_av.mat
C_HIHI += np.loadtxt('../KHI_cov/KHI_covzHI'+sys.argv[1]+'_kzs13_av.mat') # 15 bins 35 realisation 
...
np.savetxt('F_ij_p18vKHI_zH'+sys.argv[1]+'_zs13_bias1.mat',F)

np.savetxt('F_p18vKHI_zH'+sys.argv[1]+'_zs13_bias1_inv.mat',inv(F))
