...
FP2 = np.zeros((7,7))
for i in range(16):
   F = F+np.loadtxt('F_ij_p18vHIHI_zH'+str(i+1)+'_bias1_7params.mat')
   FP2 = FP2+np.loadtxt('F_ij_p18vKHI_zH'+str(i+1)+'_zs23_bias1_7params.mat')
   if(i<9):
     FP = FP+np.loadtxt('F_ij_p18vKHI_zH'+str(i+1)+'_zs13_bias1_7params.mat')
   if(i==3):
      F1=F1+F 
   if(i==7):
      F2=F2+F
...
for i in range(5):
    FT2 = FT2 + np.loadtxt('F_ij_p18vKHI_zH'+str(i+1)+'_zs8_bias1_7params.mat')
...
#print(covariance)
#print('\n\n ')
print((covarianceT[0][0]**0.5)*2,(covarianceT[1][1]**0.5)*2,(covarianceT[2][2]**0.5)*2,(covarianceT[3][3]**0.5)*2,(covarianceT[4][4]**0.5)*2,(covarianceT[5][5]**0.5)*2,(covarianceT[6][6]**0.5)*2)
mean = [0.7, 0.3,  0.8, 0.97, 0.67, 0.19, 0.05] 
'''
...
'''
#print(covariance)
gauss1=GaussianND(mean, covariance,names=['h0','Om', 'sigma8','ns','b0','b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
gauss2=GaussianND(mean, inv(F1),names=['h0','Om', 'sigma8','ns','b0','b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
gauss3=GaussianND(mean, inv(F2),names=['h0','Om', 'sigma8','ns','b0','b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
gauss4=GaussianND(mean, inv(F3),names=['h0','Om', 'sigma8','ns','b0','b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
gauss5=GaussianND(mean, covarianceP,names=['h0','Om', 'sigma8','ns','b0','b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
gauss6=GaussianND(mean, inv(F+FP),names=['h0','Om', 'sigma8','ns','b0','b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
gauss7=GaussianND(mean, covarianceP2,names=['h0','Om', 'sigma8','ns','b0','b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
gauss8=GaussianND(mean, covarianceT,names=['h0','Om', 'sigma8','ns','b0','b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
gauss9=GaussianND(mean, inv(FT2),names=['h0','Om', 'sigma8','ns','b0', 'b1','b2'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'b_0',r'b_1',r'b_2'])
...
plt.savefig('7params_planck_16HIHI_3-K.png')
plt.close()
...
plt.legend()
#plt.show()
plt.savefig('FoM_7params-bias2.png')
