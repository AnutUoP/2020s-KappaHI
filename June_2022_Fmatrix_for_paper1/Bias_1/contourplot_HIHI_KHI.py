...
#print(covariance)
#print('\n\n ')
#print((covarianceT[1][1]**0.5)*2)


sigma_0 = (inv(FT2)[0][0]**0.5)*2
sigma_1 = (inv(FT2)[1][1]**0.5)*2
sigma_2 = (inv(FT2)[2][2]**0.5)*2
sigma_3 = (inv(FT2)[3][3]**0.5)*2
sigma_4 = (inv(FT2)[4][4]**0.5)*2

print(sigma_0, sigma_1, sigma_2, sigma_3, sigma_4)
...
'''
#print(covariance)
gauss1=GaussianND(mean, covariance,names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
gauss2=GaussianND(mean, inv(F1),names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
gauss3=GaussianND(mean, inv(F2),names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
gauss4=GaussianND(mean, inv(F3),names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
gauss5=GaussianND(mean, covarianceP,names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
gauss6=GaussianND(mean, inv(F+FP),names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
gauss7=GaussianND(mean, covarianceP2,names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
gauss8=GaussianND(mean, covarianceT,names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
gauss9=GaussianND(mean, inv(FT2),names=['h0','Om', 'sigma8','ns','alpha'], labels=[r'h_0', r'\Omega_\mathrm{m}', r'\sigma_8',r'n_s',r'\alpha'])
...
plt.savefig('bias1_planck_16HIHI_9KHI_16KHI_5KHI_v3.png')
plt.close()
...
y3 = FoMP/(10**5)
y4 = FoMPP/(10**5)
plt.plot(x,y1,'go',label=r'16-HIHI')
plt.plot(xp,y2, '*', color='0.5', label=r'16-HIHI+1-$\kappa$')
plt.plot(xp2,y3,'r+',label = r'16-HIHI+2-$\kappa$')
plt.plot(xp3,y4,'bp', label = r'16-HIHI+3-$\kappa$')
plt.xlabel('# of redshift pairs')
plt.ylabel(r'FoM $\times$ $10^{-5}$')
plt.title(r'$\Omega_\mathrm{m}-\sigma_8$ FoM')
#plt.ylabel('FoM')
plt.xticks()
plt.legend(loc='lower right')
#plt.show()
plt.savefig('FoM_HIHI_9ks16ks5ks.png')
